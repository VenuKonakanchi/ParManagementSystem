...
<button type="button" class="btn btn-sm btn-primary" id="addNewSkillBtn">Add
	New Skill</button>
<p></p>
<table id="tblSkills"
...
<div class="modal fade" id="confirmSkillDeleteModal" tabindex="-1"
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="skill-delete-btn">Delete</button>
					...
					<div class="card-body">
						<form class="form-horizontal" role="form" id="skillForm">
							<div class="form-group  row">
								...
								<div
									class="col-sm-6 col-sm-6 input-group  modal-form-input-group">
									<div class="input-group input-group-prepend">
										<span class="input-group-text modal-form-field-prepend-span"
											id="name-addon"><i class="fa fa-gear"></i></span> <input
											type="text" class="form-control" id="skillName"
											placeholder=" " name="skillName">
									</div>
								</div>
